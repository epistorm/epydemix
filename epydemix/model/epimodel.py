...
class EpiModel:
    ...
    def create_default_initial_conditions(
        ...
        agent_compartments = list(dict.fromkeys(
        ...
        mediated_targets = {tr.target for tr in self.transitions_list if tr.kind == "mediated"}
        source_compartments = list(dict.fromkeys(
            tr.source for tr in self.transitions_list
        ...
        if not source_compartments:
            ...
            candidates = [c for c, n in mediated_source_counts.items() if n == max_count]
            ...
            source_compartments = non_mediated_targets if non_mediated_targets else candidates
